...
const SearchResults = () => {
    ...
    // url arama parametresine ulaş
    const query = searchParams.get("search_query");
    // apiden aratılan kelimeye uygun videoları al
    useEffect(() => {
        setIsLoading(true);
        // Egerki sayfa saysı artıysa token parametreye ekle
    ...
    //    aratılan kelime her degiştigind stateleri sıfırla
    useEffect(() => {
        setData([]);
        setToken(null);
        setPage(1);
    ...
    return (
        <div className="p-4 sm:p-6 md:p-10 h-[93vh] 
         overflow-y-auto">
